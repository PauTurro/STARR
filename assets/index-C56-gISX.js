 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var sm;function nb(){if(sm)return re;sm=1;var s=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),_=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),E=Symbol.iterator;function S(b){return b===null||typeof b!="object"?null:(b=E&&b[E]||b["@@iterator"],typeof b=="function"?b:null)}var x={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},L=Object.assign,j={};function B(b,k,P){this.props=b,this.context=k,this.refs=j,this.updater=P||x}B.prototype.isReactComponent={},B.prototype.setState=function(b,k){if(typeof b!="object"&&typeof b!="function"&&b!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,b,k,"setState")},B.prototype.forceUpdate=function(b){this.updater.enqueueForceUpdate(this,b,"forceUpdate")};function fe(){}fe.prototype=B.prototype;function ne(b,k,P){this.props=b,this.context=k,this.refs=j,this.updater=P||x}var Y=ne.prototype=new fe;Y.constructor=ne,L(Y,B.prototype),Y.isPureReactComponent=!0;var W=Array.isArray,G={H:null,A:null,T:null,S:null,V:null},Ce=Object.prototype.hasOwnProperty;function we(b,k,P,H,K,ve){return P=ve.ref,{$$typeof:s,type:b,key:k,ref:P!==void 0?P:null,props:ve}}function Pe(b,k){return we(b.type,k,void 0,void 0,void 0,b.props)}function xe(b){return typeof b=="object"&&b!==null&&b.$$typeof===s}function se(b){var k={"=":"=0",":":"=2"};return"$"+b.replace(/[=:]/g,function(P){return k[P]})}var ie=/\/+/g;function Q(b,k){return typeof b=="object"&&b!==null&&b.key!=null?se(""+b.key):k.toString(36)}function he(){}function Se(b){switch(b.status){case"fulfilled":return b.value;case"rejected":throw b.reason;default:switch(typeof b.status=="string"?b.then(he,he):(b.status="pending",b.then(function(k){b.status==="pending"&&(b.status="fulfilled",b.value=k)},function(k){b.status==="pending"&&(b.status="rejected",b.reason=k)})),b.status){case"fulfilled":return b.value;case"rejected":throw b.reason}}throw b}function He(b,k,P,H,K){var ve=typeof b;(ve==="undefined"||ve==="boolean")&&(b=null);var ae=!1;if(b===null)ae=!0;else switch(ve){case"bigint":case"string":case"number":ae=!0;break;case"object":switch(b.$$typeof){case s:case t:ae=!0;break;case v:return ae=b._init,He(ae(b._payload),k,P,H,K)}}if(ae)return K=K(b),ae=H===""?"."+Q(b,0):H,W(K)?(P="",ae!=null&&(P=ae.replace(ie,"$&/")+"/"),He(K,k,P,"",function(Hn){return Hn})):K!=null&&(xe(K)&&(K=Pe(K,P+(K.key==null||b&&b.key===K.key?"":(""+K.key).replace(ie,"$&/")+"/")+ae)),k.push(K)),1;ae=0;var Rt=H===""?".":H+":";if(W(b))for(var Be=0;Be<b.length;Be++)H=b[Be],ve=Rt+Q(H,Be),ae+=He(H,k,P,ve,K);else if(Be=S(b),typeof Be=="function")for(b=Be.call(b),Be=0;!(H=b.next()).done;)H=H.value,ve=Rt+Q(H,Be++),ae+=He(H,k,P,ve,K);else if(ve==="object"){if(typeof b.then=="function")return He(Se(b),k,P,H,K);throw k=String(b),Error("Objects are not valid as a React child (found: "+(k==="[object Object]"?"object with keys {"+Object.keys(b).join(", ")+"}":k)+"). If you meant to render a collection of children, use an array instead.")}return ae}function O(b,k,P){if(b==null)return b;var H=[],K=0;return He(b,H,"","",function(ve){return k.call(P,ve,K++)}),H}function z(b){if(b._status===-1){var k=b._result;k=k(),k.then(function(P){(b._status===0||b._status===-1)&&(b._status=1,b._result=P)},function(P){(b._status===0||b._status===-1)&&(b._status=2,b._result=P)}),b._status===-1&&(b._status=0,b._result=k)}if(b._status===1)return b._result.default;throw b._result}var F=typeof reportError=="function"?reportError:function(b){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var k=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof b=="object"&&b!==null&&typeof b.message=="string"?String(b.message):String(b),error:b});if(!window.dispatchEvent(k))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",b);return}console.error(b)};function be(){}return re.Children={map:O,forEach:function(b,k,P){O(b,function(){k.apply(this,arguments)},P)},count:function(b){var k=0;return O(b,function(){k++}),k},toArray:function(b){return O(b,function(k){return k})||[]},only:function(b){if(!xe(b))throw Error("React.Children.only expected to receive a single React element child.");return b}},re.Component=B,re.Fragment=i,re.Profiler=o,re.PureComponent=ne,re.StrictMode=r,re.Suspense=_,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=G,re.__COMPILER_RUNTIME={__proto__:null,c:function(b){return G.H.useMemoCache(b)}},re.cache=function(b){return function(){return b.apply(null,arguments)}},re.cloneElement=function(b,k,P){if(b==null)throw Error("The argument must be a React element, but you passed "+b+".");var H=L({},b.props),K=b.key,ve=void 0;if(k!=null)for(ae in k.ref!==void 0&&(ve=void 0),k.key!==void 0&&(K=""+k.key),k)!Ce.call(k,ae)||ae==="key"||ae==="__self"||ae==="__source"||ae==="ref"&&k.ref===void 0||(H[ae]=k[ae]);var ae=arguments.length-2;if(ae===1)H.children=P;else if(1<ae){for(var Rt=Array(ae),Be=0;Be<ae;Be++)Rt[Be]=arguments[Be+2];H.children=Rt}return we(b.type,K,void 0,void 0,ve,H)},re.createContext=function(b){return b={$$typeof:h,_currentValue:b,_currentValue2:b,_threadCount:0,Provider:null,Consumer:null},b.Provider=b,b.Consumer={$$typeof:c,_context:b},b},re.createElement=function(b,k,P){var H,K={},ve=null;if(k!=null)for(H in k.key!==void 0&&(ve=""+k.key),k)Ce.call(k,H)&&H!=="key"&&H!=="__self"&&H!=="__source"&&(K[H]=k[H]);var ae=arguments.length-2;if(ae===1)K.children=P;else if(1<ae){for(var Rt=Array(ae),Be=0;Be<ae;Be++)Rt[Be]=arguments[Be+2];K.children=Rt}if(b&&b.defaultProps)for(H in ae=b.defaultProps,ae)K[H]===void 0&&(K[H]=ae[H]);return we(b,ve,void 0,void 0,null,K)},re.createRef=function(){return{current:null}},re.forwardRef=function(b){return{$$typeof:d,render:b}},re.isValidElement=xe,re.lazy=function(b){return{$$typeof:v,_payload:{_status:-1,_result:b},_init:z}},re.memo=function(b,k){return{$$typeof:g,type:b,compare:k===void 0?null:k}},re.startTransition=function(b){var k=G.T,P={};G.T=P;try{var H=b(),K=G.S;K!==null&&K(P,H),typeof H=="object"&&H!==null&&typeof H.then=="function"&&H.then(be,F)}catch(ve){F(ve)}finally{G.T=k}},re.unstable_useCacheRefresh=function(){return G.H.useCacheRefresh()},re.use=function(b){return G.H.use(b)},re.useActionState=function(b,k,P){return G.H.useActionState(b,k,P)},re.useCallback=function(b,k){return G.H.useCallback(b,k)},re.useContext=function(b){return G.H.useContext(b)},re.useDebugValue=function(){},re.useDeferredValue=function(b,k){return G.H.useDeferredValue(b,k)},re.useEffect=function(b,k,P){var H=G.H;if(typeof P=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return H.useEffect(b,k)},re.useId=function(){return G.H.useId()},re.useImperativeHandle=function(b,k,P){return G.H.useImperativeHandle(b,k,P)},re.useInsertionEffect=function(b,k){return G.H.useInsertionEffect(b,k)},re.useLayoutEffect=function(b,k){return G.H.useLayoutEffect(b,k)},re.useMemo=function(b,k){return G.H.useMemo(b,k)},re.useOptimistic=function(b,k){return G.H.useOptimistic(b,k)},re.useReducer=function(b,k,P){return G.H.useReducer(b,k,P)},re.useRef=function(b){return G.H.useRef(b)},re.useState=function(b){return G.H.useState(b)},re.useSyncExternalStore=function(b,k,P){return G.H.useSyncExternalStore(b,k,P)},re.useTransition=function(){return G.H.useTransition()},re.version="19.1.0",re}var am;function ph(){return am||(am=1,Cf.exports=nb()),Cf.exports}var _e=ph();const ib=bv(_e);var wf={exports:{}},ur={},Af={exports:{}},Rf={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var rm;function sb(){return rm||(rm=1,function(s){function t(O,z){var F=O.length;O.push(z);e:for(;0<F;){var be=F-1>>>1,b=O[be];if(0<o(b,z))O[be]=z,O[F]=b,F=be;else break e}}function i(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var z=O[0],F=O.pop();if(F!==z){O[0]=F;e:for(var be=0,b=O.length,k=b>>>1;be<k;){var P=2*(be+1)-1,H=O[P],K=P+1,ve=O[K];if(0>o(H,F))K<b&&0>o(ve,H)?(O[be]=ve,O[K]=F,be=K):(O[be]=H,O[P]=F,be=P);else if(K<b&&0>o(ve,F))O[be]=ve,O[K]=F,be=K;else break e}}return z}function o(O,z){var F=O.sortIndex-z.sortIndex;return F!==0?F:O.id-z.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;s.unstable_now=function(){return c.now()}}else{var h=Date,d=h.now();s.unstable_now=function(){return h.now()-d}}var _=[],g=[],v=1,E=null,S=3,x=!1,L=!1,j=!1,B=!1,fe=typeof setTimeout=="function"?setTimeout:null,ne=typeof clearTimeout=="function"?clearTimeout:null,Y=typeof setImmediate<"u"?setImmediate:null;function W(O){for(var z=i(g);z!==null;){if(z.callback===null)r(g);else if(z.startTime<=O)r(g),z.sortIndex=z.expirationTime,t(_,z);else break;z=i(g)}}function G(O){if(j=!1,W(O),!L)if(i(_)!==null)L=!0,Ce||(Ce=!0,Q());else{var z=i(g);z!==null&&He(G,z.startTime-O)}}var Ce=!1,we=-1,Pe=5,xe=-1;function se(){return B?!0:!(s.unstable_now()-xe<Pe)}function ie(){if(B=!1,Ce){var O=s.unstable_now();xe=O;var z=!0;try{e:{L=!1,j&&(j=!1,ne(we),we=-1),x=!0;var F=S;try{t:{for(W(O),E=i(_);E!==null&&!(E.expirationTime>O&&se());){var be=E.callback;if(typeof be=="function"){E.callback=null,S=E.priorityLevel;var b=be(E.expirationTime<=O);if(O=s.unstable_now(),typeof b=="function"){E.callback=b,W(O),z=!0;break t}E===i(_)&&r(_),W(O)}else r(_);E=i(_)}if(E!==null)z=!0;else{var k=i(g);k!==null&&He(G,k.startTime-O),z=!1}}break e}finally{E=null,S=F,x=!1}z=void 0}}finally{z?Q():Ce=!1}}}var Q;if(typeof Y=="function")Q=function(){Y(ie)};else if(typeof MessageChannel<"u"){var he=new MessageChannel,Se=he.port2;he.port1.onmessage=ie,Q=function(){Se.postMessage(null)}}else Q=function(){fe(ie,0)};function He(O,z){we=fe(function(){O(s.unstable_now())},z)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(O){O.callback=null},s.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Pe=0<O?Math.floor(1e3/O):5},s.unstable_getCurrentPriorityLevel=function(){return S},s.unstable_next=function(O){switch(S){case 1:case 2:case 3:var z=3;break;default:z=S}var F=S;S=z;try{return O()}finally{S=F}},s.unstable_requestPaint=function(){B=!0},s.unstable_runWithPriority=function(O,z){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var F=S;S=O;try{return z()}finally{S=F}},s.unstable_scheduleCallback=function(O,z,F){var be=s.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?be+F:be):F=be,O){case 1:var b=-1;break;case 2:b=250;break;case 5:b=1073741823;break;case 4:b=1e4;break;default:b=5e3}return b=F+b,O={id:v++,callback:z,priorityLevel:O,startTime:F,expirationTime:b,sortIndex:-1},F>be?(O.sortIndex=F,t(g,O),i(_)===null&&O===i(g)&&(j?(ne(we),we=-1):j=!0,He(G,F-be))):(O.sortIndex=b,t(_,O),L||x||(L=!0,Ce||(Ce=!0,Q()))),O},s.unstable_shouldYield=se,s.unstable_wrapCallback=function(O){var z=S;return function(){var F=S;S=z;try{return O.apply(this,arguments)}finally{S=F}}}}(Rf)),Rf}var lm;function ab(){return lm||(lm=1,Af.exports=sb()),Af.exports}var Nf={exports:{}},pt={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nC=Math.log(2);class iC{constructor(t){const i=c=>parseInt(Math.log(c)/nC,10),r=c=>parseInt(Array(c+1).join("1"),2);this.count=i(t+1),this.current_=this.count-1;const o=r(this.count);this.bits_=t+1&o}nextBitIsOne(){const t=!(this.bits_&1<<this.current_);return this.current_--,t}}const Ao=function(s,t,i,r){s.sort(t);const o=function(_,g){const v=g-_;let E,S;if(v===0)return null;if(v===1)return E=s[_],S=i?i(E):E,new rt(S,E.node,rt.BLACK,null,null);{const x=parseInt(v/2,10)+_,L=o(_,x),j=o(x+1,g);return E=s[x],S=i?i(E):E,new rt(S,E.node,rt.BLACK,L,j)}},c=function(_){let g=null,v=null,E=s.length;const S=function(L,j){const B=E-L,fe=E;E-=L;const ne=o(B+1,fe),Y=s[B],W=i?i(Y):Y;x(new rt(W,Y.node,j,null,ne))},x=function(L){g?(g.left=L,g=L):(v=L,g=L)};for(let L=0;L<_.count;++L){const j=_.nextBitIsOne(),B=Math.pow(2,_.count-(L+1));j?S(B,rt.BLACK):(S(B,rt.BLACK),S(B,rt.RED))}return v},h=new iC(s.length),d=c(h);return new At(r||t,d)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function No(){return{value:null,children:new Map}}function gy(s,t,i){if(ge(t))s.value=i,s.children.clear();else if(s.value!==null)s.value=s.value.updateChild(t,i);else{const r=ue(t);s.children.has(r)||s.children.set(r,No());const o=s.children.get(r);t=ze(t),gy(o,t,i)}}function Jf(s,t,i){s.value!==null?i(t,s.value):dC(s,(r,o)=>{const c=new Me(t.toString()+"/"+r);Jf(o,c,i)})}function dC(s,t){s.children.forEach((i,r)=>{t(r,i)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dr{constructor(t,i){this.source=t,this.path=i,this.type=en.LISTEN_COMPLETE}operationForChild(t){return ge(this.path)?new Dr(this.source,Ee()):new Dr(this.source,ze(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zi{constructor(t,i,r){this.source=t,this.path=i,this.snap=r,this.type=en.OVERWRITE}operationForChild(t){return ge(this.path)?new Zi(this.source,Ee(),this.snap.getImmediateChild(t)):new Zi(this.source,ze(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ta{constructor(t,i,r){this.source=t,this.path=i,this.children=r,this.type=en.MERGE}operationForChild(t){if(ge(this.path)){const i=this.children.subtree(new Me(t));return i.isEmpty()?null:i.value?new Zi(this.source,Ee(),i.value):new ta(this.source,Ee(),i)}else return U(ue(this.path)===t,"Can't get a merge for a child not on the path of the operation"),new ta(this.source,ze(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bi{constructor(t,i,r){this.node_=t,this.fullyInitialized_=i,this.filtered_=r}isFullyInitialized(){return this.fullyInitialized_}isFiltered(){return this.filtered_}isCompleteForPath(t){if(ge(t))return this.isFullyInitialized()&&!this.filtered_;const i=ue(t);return this.isCompleteForChild(i)}isCompleteForChild(t){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(t)}getNode(){return this.node_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Hf;const bC=()=>(Hf||(Hf=new At(r1)),Hf);class Ue{static fromObject(t){let i=new Ue(null);return ft(t,(r,o)=>{i=i.set(new Me(r),o)}),i}constructor(t,i=bC()){this.value=t,this.children=i}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(t,i){if(this.value!=null&&i(this.value))return{path:Ee(),value:this.value};if(ge(t))return null;{const r=ue(t),o=this.children.get(r);if(o!==null){const c=o.findRootMostMatchingPathAndValue(ze(t),i);return c!=null?{path:Ye(new Me(r),c.path),value:c.value}:null}else return null}}findRootMostValueAndPath(t){return this.findRootMostMatchingPathAndValue(t,()=>!0)}subtree(t){if(ge(t))return this;{const i=ue(t),r=this.children.get(i);return r!==null?r.subtree(ze(t)):new Ue(null)}}set(t,i){if(ge(t))return new Ue(i,this.children);{const r=ue(t),c=(this.children.get(r)||new Ue(null)).set(ze(t),i),h=this.children.insert(r,c);return new Ue(this.value,h)}}remove(t){if(ge(t))return this.children.isEmpty()?new Ue(null):new Ue(null,this.children);{const i=ue(t),r=this.children.get(i);if(r){const o=r.remove(ze(t));let c;return o.isEmpty()?c=this.children.remove(i):c=this.children.insert(i,o),this.value===null&&c.isEmpty()?new Ue(null):new Ue(this.value,c)}else return this}}get(t){if(ge(t))return this.value;{const i=ue(t),r=this.children.get(i);return r?r.get(ze(t)):null}}setTree(t,i){if(ge(t))return i;{const r=ue(t),c=(this.children.get(r)||new Ue(null)).setTree(ze(t),i);let h;return c.isEmpty()?h=this.children.remove(r):h=this.children.insert(r,c),new Ue(this.value,h)}}fold(t){return this.fold_(Ee(),t)}fold_(t,i){const r={};return this.children.inorderTraversal((o,c)=>{r[o]=c.fold_(Ye(t,o),i)}),i(t,this.value,r)}findOnPath(t,i){return this.findOnPath_(t,Ee(),i)}findOnPath_(t,i,r){const o=this.value?r(i,this.value):!1;if(o)return o;if(ge(t))return null;{const c=ue(t),h=this.children.get(c);return h?h.findOnPath_(ze(t),Ye(i,c),r):null}}foreachOnPath(t,i){return this.foreachOnPath_(t,Ee(),i)}foreachOnPath_(t,i,r){if(ge(t))return this;{this.value&&r(i,this.value);const o=ue(t),c=this.children.get(o);return c?c.foreachOnPath_(ze(t),Ye(i,o),r):new Ue(null)}}foreach(t){this.foreach_(Ee(),t)}foreach_(t,i){this.children.inorderTraversal((r,o)=>{o.foreach_(Ye(t,r),i)}),this.value&&i(t,this.value)}foreachChild(t){this.children.inorderTraversal((i,r)=>{r.value&&t(i,r.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PC(s){return{filter:s}}function BC(s,t){U(t.eventCache.getNode().isIndexed(s.filter.getIndex()),"Event snap not indexed"),U(t.serverCache.getNode().isIndexed(s.filter.getIndex()),"Server snap not indexed")}function qC(s,t,i,r,o){const c=new zC;let h,d;if(i.type===en.OVERWRITE){const g=i;g.source.fromUser?h=nh(s,t,g.path,g.snap,r,o,c):(U(g.source.fromServer,"Unknown source."),d=g.source.tagged||t.serverCache.isFiltered()&&!ge(g.path),h=xo(s,t,g.path,g.snap,r,o,d,c))}else if(i.type===en.MERGE){const g=i;g.source.fromUser?h=VC(s,t,g.path,g.children,r,o,c):(U(g.source.fromServer,"Unknown source."),d=g.source.tagged||t.serverCache.isFiltered(),h=ih(s,t,g.path,g.children,r,o,d,c))}else if(i.type===en.ACK_USER_WRITE){const g=i;g.revert?h=FC(s,t,g.path,r,o,c):h=GC(s,t,g.path,g.affectedTree,r,o,c)}else if(i.type===en.LISTEN_COMPLETE)h=YC(s,t,i.path,r,c);else throw sa("Unknown operation type: "+i.type);const _=c.getChanges();return jC(t,h,_),{viewCache:h,changes:_}}function jC(s,t,i){const r=t.eventCache;if(r.isFullyInitialized()){const o=r.getNode().isLeafNode()||r.getNode().isEmpty(),c=Do(s);(i.length>0||!s.eventCache.isFullyInitialized()||o&&!r.getNode().equals(c)||!r.getNode().getPriority().equals(c.getPriority()))&&i.push(_y(Do(t)))}}function Cy(s,t,i,r,o,c){const h=t.eventCache;if(Mo(r,i)!=null)return t;{let d,_;if(ge(i))if(U(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const g=Ji(t),v=g instanceof $?g:$.EMPTY_NODE,E=Uh(r,v);d=s.filter.updateFullNode(t.eventCache.getNode(),E,c)}else{const g=Io(r,Ji(t));d=s.filter.updateFullNode(t.eventCache.getNode(),g,c)}else{const g=ue(i);if(g===".priority"){U(Si(i)===1,"Can't have a priority with additional path components");const v=h.getNode();_=t.serverCache.getNode();const E=Ym(r,i,v,_);E!=null?d=s.filter.updatePriority(v,E):d=h.getNode()}else{const v=ze(i);let E;if(h.isCompleteForChild(g)){_=t.serverCache.getNode();const S=Ym(r,i,h.getNode(),_);S!=null?E=h.getNode().getImmediateChild(g).updateChild(v,S):E=h.getNode().getImmediateChild(g)}else E=zh(r,g,t.serverCache);E!=null?d=s.filter.updateChild(h.getNode(),g,E,v,o,c):d=h.getNode()}}return yr(t,d,h.isFullyInitialized()||ge(i),s.filter.filtersNodes())}}function xo(s,t,i,r,o,c,h,d){const _=t.serverCache;let g;const v=h?s.filter:s.filter.getIndexedFilter();if(ge(i))g=v.updateFullNode(_.getNode(),r,null);else if(v.filtersNodes()&&!_.isFiltered()){const x=_.getNode().updateChild(i,r);g=v.updateFullNode(_.getNode(),x,null)}else{const x=ue(i);if(!_.isCompleteForPath(i)&&Si(i)>1)return t;const L=ze(i),B=_.getNode().getImmediateChild(x).updateChild(L,r);x===".priority"?g=v.updatePriority(_.getNode(),B):g=v.updateChild(_.getNode(),x,B,L,Ty,null)}const E=my(t,g,_.isFullyInitialized()||ge(i),v.filtersNodes()),S=new Hh(o,E,c);return Cy(s,E,i,o,S,d)}function nh(s,t,i,r,o,c,h){const d=t.eventCache;let _,g;const v=new Hh(o,t,c);if(ge(i))g=s.filter.updateFullNode(t.eventCache.getNode(),r,h),_=yr(t,g,!0,s.filter.filtersNodes());else{const E=ue(i);if(E===".priority")g=s.filter.updatePriority(t.eventCache.getNode(),r),_=yr(t,g,d.isFullyInitialized(),d.isFiltered());else{const S=ze(i),x=d.getNode().getImmediateChild(E);let L;if(ge(S))L=r;else{const j=v.getCompleteChild(E);j!=null?Rh(S)===".priority"&&j.getChild(oy(S)).isEmpty()?L=j:L=j.updateChild(S,r):L=$.EMPTY_NODE}if(x.equals(L))_=t;else{const j=s.filter.updateChild(d.getNode(),E,L,S,v,h);_=yr(t,j,d.isFullyInitialized(),s.filter.filtersNodes())}}}return _}function Fm(s,t){return s.eventCache.isCompleteForChild(t)}function VC(s,t,i,r,o,c,h){let d=t;return r.foreach((_,g)=>{const v=Ye(i,_);Fm(t,ue(v))&&(d=nh(s,d,v,g,o,c,h))}),r.foreach((_,g)=>{const v=Ye(i,_);Fm(t,ue(v))||(d=nh(s,d,v,g,o,c,h))}),d}function Qm(s,t,i){return i.foreach((r,o)=>{t=t.updateChild(r,o)}),t}function ih(s,t,i,r,o,c,h,d){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let _=t,g;ge(i)?g=r:g=new Ue(null).setTree(i,r);const v=t.serverCache.getNode();return g.children.inorderTraversal((E,S)=>{if(v.hasChild(E)){const x=t.serverCache.getNode().getImmediateChild(E),L=Qm(s,x,S);_=xo(s,_,new Me(E),L,o,c,h,d)}}),g.children.inorderTraversal((E,S)=>{const x=!t.serverCache.isCompleteForChild(E)&&S.value===null;if(!v.hasChild(E)&&!x){const L=t.serverCache.getNode().getImmediateChild(E),j=Qm(s,L,S);_=xo(s,_,new Me(E),j,o,c,h,d)}}),_}function GC(s,t,i,r,o,c,h){if(Mo(o,i)!=null)return t;const d=t.serverCache.isFiltered(),_=t.serverCache;if(r.value!=null){if(ge(i)&&_.isFullyInitialized()||_.isCompleteForPath(i))return xo(s,t,i,_.getNode().getChild(i),o,c,d,h);if(ge(i)){let g=new Ue(null);return _.getNode().forEachChild(Qs,(v,E)=>{g=g.set(new Me(v),E)}),ih(s,t,i,g,o,c,d,h)}else return t}else{let g=new Ue(null);return r.foreach((v,E)=>{const S=Ye(i,v);_.isCompleteForPath(S)&&(g=g.set(v,_.getNode().getChild(S)))}),ih(s,t,i,g,o,c,d,h)}}function YC(s,t,i,r,o){const c=t.serverCache,h=my(t,c.getNode(),c.isFullyInitialized()||ge(i),c.isFiltered());return Cy(s,h,i,r,Ty,o)}function FC(s,t,i,r,o,c){let h;if(Mo(r,i)!=null)return t;{const d=new Hh(r,t,o),_=t.eventCache.getNode();let g;if(ge(i)||ue(i)===".priority"){let v;if(t.serverCache.isFullyInitialized())v=Io(r,Ji(t));else{const E=t.serverCache.getNode();U(E instanceof $,"serverChildren would be complete if leaf node"),v=Uh(r,E)}v=v,g=s.filter.updateFullNode(_,v,c)}else{const v=ue(i);let E=zh(r,v,t.serverCache);E==null&&t.serverCache.isCompleteForChild(v)&&(E=_.getImmediateChild(v)),E!=null?g=s.filter.updateChild(_,v,E,ze(i),d,c):t.eventCache.getNode().hasChild(v)?g=s.filter.updateChild(_,v,$.EMPTY_NODE,ze(i),d,c):g=_,g.isEmpty()&&t.serverCache.isFullyInitialized()&&(h=Io(r,Ji(t)),h.isLeafNode()&&(g=s.filter.updateFullNode(g,h,c)))}return h=t.serverCache.isFullyInitialized()||Mo(r,Ee())!=null,yr(t,g,h,s.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ho=new yh("@firebase/auth");function hA(s,...t){Ho.logLevel<=Ie.WARN&&Ho.warn(`Auth (${ra}): ${s}`,...t)}function go(s,...t){Ho.logLevel<=Ie.ERROR&&Ho.error(`Auth (${ra}): ${s}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function br(s){if(s)try{const t=new Date(Number(s));if(!isNaN(t.getTime()))return t.toUTCString()}catch{}}async function CA(s,t=!1){const i=Et(s),r=await i.getIdToken(t),o=sd(r);J(o&&o.exp&&o.auth_time&&o.iat,i.auth,"internal-error");const c=typeof o.firebase=="object"?o.firebase:void 0,h=c==null?void 0:c.sign_in_provider;return{claims:o,token:r,authTime:br(qf(o.auth_time)),issuedAtTime:br(qf(o.iat)),expirationTime:br(qf(o.exp)),signInProvider:h||null,signInSecondFactor:(c==null?void 0:c.sign_in_second_factor)||null}}function qf(s){return Number(s)*1e3}function sd(s){const[t,i,r]=s.split(".");if(t===void 0||i===void 0||r===void 0)return go("JWT malformed, contained fewer than 3 sections"),null;try{const o=So(i);return o?JSON.parse(o):(go("Failed to decode base64 JWT payload"),null)}catch(o){return go("Caught error parsing JWT payload as JSON",o==null?void 0:o.toString()),null}}function av(s){const t=sd(s);return J(t,"internal-error"),J(typeof t.exp<"u","internal-error"),J(typeof t.iat<"u","internal-error"),Number(t.exp)-Number(t.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nR(s){switch(s){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function iR(s){const t=pr(_r(s)).link,i=t?pr(_r(t)).deep_link_id:null,r=pr(_r(s)).deep_link_id;return(r?pr(_r(r)).link:null)||r||i||t||s}class ld{constructor(t){var i,r,o,c,h,d;const _=pr(_r(t)),g=(i=_.apiKey)!==null&&i!==void 0?i:null,v=(r=_.oobCode)!==null&&r!==void 0?r:null,E=nR((o=_.mode)!==null&&o!==void 0?o:null);J(g&&v&&E,"argument-error"),this.apiKey=g,this.operation=E,this.code=v,this.continueUrl=(c=_.continueUrl)!==null&&c!==void 0?c:null,this.languageCode=(h=_.lang)!==null&&h!==void 0?h:null,this.tenantId=(d=_.tenantId)!==null&&d!==void 0?d:null}static parseLink(t){const i=iR(t);try{return new ld(i)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */vi(AN,RN,"app");const NN={apiKey:"AIzaSyDWMkL3P7OWlosSFXXRg8gvUQg6-7Y9uu8",authDomain:"esp32door-control.firebaseapp.com",databaseURL:"https://esp32door-control-default-rtdb.firebaseio.com/",projectId:"esp32door-control",storageBucket:"esp32door-control.appspot.com",messagingSenderId:"605127991992",appId:"1:605127991992:web:4d0dccf6ae2d874603ca4d",measurementId:"G-91SJ3GLZ0Z"},D0=Lv(NN),po=CN(D0),Jt=uh(D0),ON=15,DN=()=>Array.from({length:8},()=>"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".charAt(Math.floor(Math.random()*62))).join("");function I0(){const[s,t]=_e.useState(null),[i,r]=_e.useState([]),[o,c]=_e.useState({}),[h,d]=_e.useState({}),[_,g]=_e.useState(!1),[v,E]=_e.useState(!1),[S,x]=_e.useState(null),L=_e.useRef(null),j=_e.useCallback(()=>{L.current&&(clearTimeout(L.current),L.current=null),x(null)},[]),B=_e.useCallback(se=>{L.current&&clearTimeout(L.current),x(se),se&&(L.current=setTimeout(()=>{x(null),L.current=null},4e3))},[]),fe=async(se,ie)=>{j();try{(await oR(po,se,ie)).user&&console.log("User registered and initial tokens set.")}catch(Q){Q.code==="auth/email-already-in-use"?B("Email already registered"):Q.code==="auth/weak-password"?B("6 characters or more"):Q.code==="auth/invalid-email"?B("Invalid email"):B("Registration failed. Please try again.")}},ne=async(se,ie)=>{j();try{await uR(po,se,ie)}catch(Q){["auth/user-not-found","auth/invalid-credential","auth/wrong-password","auth/invalid-email"].includes(Q.code),B("Wrong email or password")}},Y=async()=>{j(),await dR(po)},W=async se=>{const ie=`tokens/${se}/buttonStatus`,Q=await fo(gt(Jt,ie)),Se=(Q.exists()?Q.val():"closed")==="open"?"closed":"open";await ci(gt(Jt,ie),Se)},G=async(se,ie)=>{if(!s||!i.includes(se))return;const Q=`tokens/${se}/buttonName`;try{await ci(gt(Jt,Q),ie||null)}catch(he){console.error("Error updating button name:",he),B("Failed to update name.")}},Ce=async(se,ie)=>{await ci(gt(Jt,`tokens/${se}/authorizedUsers/${ie}`),!0);const Q=gt(Jt,`users/${ie}/deviceTokens`),he=await fo(Q),Se=he.exists()&&Array.isArray(he.val())?he.val():[];Se.includes(se)||await ci(Q,[...Se,se])},we=async(se,ie)=>{await ci(gt(Jt,`tokens/${se}/authorizedUsers/${ie}`),null);const Q=gt(Jt,`users/${ie}/deviceTokens`),he=await fo(Q),Se=he.exists()&&Array.isArray(he.val())?he.val():[];Se.includes(se)&&await ci(Q,Se.filter(He=>He!==se))},Pe=_e.useCallback(async se=>{const ie=gt(Jt,`users/${se}/deviceTokens`),Q=await fo(ie);let he=[];if(Q.exists()&&Array.isArray(Q.val()))he=Q.val();else{const Se=Array.from({length:ON},DN);he=Se;const He={[`/users/${se}/deviceTokens`]:he};Se.forEach(O=>{He[`/tokens/${O}`]={owner:se,authorizedUsers:{[se]:!0},buttonStatus:"hello"}}),await eA(gt(Jt),He)}r(he),g(!1),xe(he)},[]),xe=se=>{const ie={},Q={};if(c({}),d({}),g(!1),se.length===0){g(!0);return}const he=()=>{Object.keys(ie).length===se.length&&Object.keys(Q).length===se.length&&g(!0)};se.forEach(Se=>{const He=gt(Jt,`tokens/${Se}/buttonStatus`);zo(He,z=>{let F=z.val();typeof F!="string"&&(F="closed"),c(be=>({...be,[Se]:F})),ie[Se]=!0,he()},z=>{console.error(`Error listening to status for ${Se}:`,z),ie[Se]=!0,he()});const O=gt(Jt,`tokens/${Se}/buttonName`);zo(O,z=>{const F=z.val()||null;d(be=>({...be,[Se]:F})),Q[Se]=!0,he()},z=>{console.error(`Error listening to name for ${Se}:`,z),Q[Se]=!0,he()})})};return _e.useEffect(()=>hR(po,ie=>{t(ie),ie?Pe(ie.uid):(r([]),c({}),d({}),g(!1),j()),E(!0)}),[Pe,j]),_e.useEffect(()=>()=>{L.current&&clearTimeout(L.current)},[]),{user:s,tokens:i,buttonState:o,buttonNames:h,isButtonDataLoaded:_,authChecked:v,error:S,register:fe,login:ne,logout:Y,toggleButton:W,updateButtonName:G,shareToken:Ce,revokeShare:we,clearError:j}}function IN({onShowControlPanel:s,onShowSettings:t,onShowCameraPage:i,onLogout:r,onLoadingChange:o,containerFadedIn:c}){console.log("CameraPage component is rendering");const[h,d]=_e.useState({}),[_,g]=_e.useState({}),[v,E]=_e.useState(!0),{tokens:S,authChecked:x}=I0();_e.useEffect(()=>{if(!x)return;o&&o(!0);const B=uh(),fe=[],ne={};if(S.length===0){E(!1),d({}),g({});return}return E(!0),S.forEach(Y=>{const W=gt(B,`tokens/${Y}/camera/imageUrl`),G=gt(B,`tokens/${Y}/button name`);console.log("📡 Watching:",`tokens/${Y}/camera/imageUrl`,`tokens/${Y}/button name`),ne[Y]={imageUrlLoaded:!1,buttonNameLoaded:!1};const Ce=zo(W,Pe=>{const xe=Pe.val();d(ie=>{const Q={...ie};return xe&&typeof xe=="string"&&xe.startsWith("http")?Q[Y]=xe+`&cb=${Date.now()}`:delete Q[Y],Q}),ne[Y].imageUrlLoaded=!0,ne[Y].buttonNameLoaded&&(ne[Y]=!0),Object.values(ne).every(ie=>ie===!0)&&E(!1)});fe.push(Ce);const we=zo(G,Pe=>{const xe=Pe.val();g(ie=>{const Q={...ie};return xe?Q[Y]=xe:delete Q[Y],Q}),ne[Y].buttonNameLoaded=!0,ne[Y].imageUrlLoaded&&(ne[Y]=!0),Object.values(ne).every(ie=>ie===!0)&&E(!1)});fe.push(we)}),()=>{fe.forEach(Y=>Y()),o&&o(!0)}},[S,x,o]),_e.useEffect(()=>{o&&o(v)},[v,o]);const L=async()=>{const B=uh();for(const fe of S){const ne=`tokens/${fe}/photo`;try{await ci(gt(B,ne),"snap"),console.log(`Sent 'snap' command to token: ${fe}`),setTimeout(async()=>{await ci(gt(B,ne),"hello"),console.log(`Sent 'hello' command to token: ${fe}`)},1e3)}catch(Y){console.error(`Error sending command to token ${fe}:`,Y)}}},j=Object.keys(h).length>0;return te.jsxs("div",{className:"camera-fullscreen-container",children:[te.jsx("button",{onClick:L,style:{marginTop:"20px",marginBottom:"20px",marginRight:"20px",marginLeft:"20px",padding:"10px 20px",fontSize:"16px",color:"white",backgroundColor:"#faaccc"},className:c?"fade-in-element":"",children:"Refresh"}),v?te.jsx("p",{style:{textAlign:"center",marginTop:"0px",minHeight:"300px"},className:c?"fade-in-element delay-1":"",children:"Loading cameras..."}):j?te.jsx("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",marginTop:"10px",width:"100%",maxWidth:"100vw",overflowX:"hidden"},className:c?"fade-in-element delay-2":"",children:S.map(B=>h[B]?te.jsxs("div",{style:{marginBottom:"90px",width:"100%",display:"flex",flexDirection:"column",alignItems:"center"},children:[te.jsx("h3",{style:{marginBottom:"30px"},children:_[B]||`Token: ${B}`}),te.jsx("img",{src:h[B],alt:`Camera Snapshot for ${B}`,style:{width:"100%",maxWidth:"400px",height:"auto",objectFit:"contain",borderRadius:"16px",boxShadow:"0 5px 13px rgba(0, 0, 0, 0.2)",transform:"rotate(90deg)"}})]},B):null)}):te.jsx("p",{style:{textAlign:"center",marginTop:"70px",minHeight:"300px"},className:c?"fade-in-element delay-1":"",children:"No images available."}),te.jsx(_h,{onShowControlPanel:s,onShowSettings:t,onShowCameraPage:i,onLogout:r})]})}window.navigator.standalone===!0&&document.documentElement.classList.add("ios-standalone");function MN(){const{user:s,token:t,tokens:i,buttonState:r,isButtonDataLoaded:o,buttonNames:c,updateButtonName:h,error:d,register:_,login:g,logout:v,toggleButton:E,clearError:S}=I0(),[x,L]=_e.useState(!1),[j,B]=_e.useState(!1),[fe,ne]=_e.useState(!1),[Y,W]=_e.useState(!1),[G,Ce]=_e.useState(!0),[we,Pe]=_e.useState(()=>{const he=localStorage.getItem("settingsMessages");return he?JSON.parse(he):[]});_e.useEffect(()=>{localStorage.setItem("settingsMessages",JSON.stringify(we))},[we]),_e.useEffect(()=>{if(d){L(!0);const he=setTimeout(()=>L(!1),3500);return()=>clearTimeout(he)}else L(!1)},[d]);const xe=()=>{B(!1),ne(!1),W(!1)},se=()=>{B(!0),ne(!1),W(!1)},ie=()=>{ne(!0),B(!1),setTimeout(()=>{W(!0)},50)},Q=()=>{B(!1)};return _e.useEffect(()=>{W(!!(fe&&!G))},[fe,G]),te.jsxs("div",{id:"appContainer",className:"fade-in background",children:[d&&te.jsx("div",{className:`error-banner ${x?"visible":"fade-out"}`,children:d}),te.jsxs("div",{className:s?"control-panel-screen":"container",id:"containerEl",children:[te.jsx("h1",{className:"title",children:s?"":"Welcome to the future"}),s?j?te.jsx(pb,{tokens:i,onLogout:v,onClose:Q,onReturnToControlPanel:xe,message:we,onShowSettings:se,onShowCameraPage:ie}):fe?te.jsx("div",{className:`camera-fade-container ${Y?"fade-in":""}`,children:te.jsx(IN,{token:t,tokens:i,onShowControlPanel:xe,onShowSettings:se,onShowCameraPage:ie,onLogout:v,buttonNames:c,onLoadingChange:Ce,containerFadedIn:Y})}):te.jsx(db,{token:t,tokens:i,onToggleButtonPress:(he,Se)=>Pe(He=>[...He,`${he} ${Se} ${new Date().toLocaleTimeString("es-ES",{hour:"2-digit",minute:"2-digit",hourCycle:"h23"})}`]),buttonState:r,buttonNames:c,isButtonDataLoaded:o,onToggle:E,onUpdateName:h,onLogout:v,onShowSettings:se,onShowCameraPage:ie}):te.jsx(hb,{onLogin:g,onRegister:_,error:d,setError:S})]})]})}window.navigator.standalone===!0&&document.documentElement.classList.add("ios-standalone");fb.createRoot(document.getElementById("root")).render(te.jsx(ib.StrictMode,{children:te.jsx(MN,{})}));"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/STARR/service-worker.js").then(s=>{console.log("✅ Service Worker registered with scope:",s.scope),s.onupdatefound=()=>{const t=s.installing;t&&(t.onstatechange=()=>{t.state==="installed"&&navigator.serviceWorker.controller&&confirm("🚀 New version available! Reload now?")&&window.location.reload()})}}).catch(s=>{console.error("❌ Service Worker registration failed:",s)})});
