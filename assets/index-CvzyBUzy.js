 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Jg;function KS(){if(Jg)return ee;Jg=1;var s=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),_=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),E=Symbol.iterator;function C(S){return S===null||typeof S!="object"?null:(S=E&&S[E]||S["@@iterator"],typeof S=="function"?S:null)}var x={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},U=Object.assign,G={};function Z(S,k,P){this.props=S,this.context=k,this.refs=G,this.updater=P||x}Z.prototype.isReactComponent={},Z.prototype.setState=function(S,k){if(typeof S!="object"&&typeof S!="function"&&S!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,S,k,"setState")},Z.prototype.forceUpdate=function(S){this.updater.enqueueForceUpdate(this,S,"forceUpdate")};function Q(){}Q.prototype=Z.prototype;function Ne(S,k,P){this.props=S,this.context=k,this.refs=G,this.updater=P||x}var ge=Ne.prototype=new Q;ge.constructor=Ne,U(ge,Z.prototype),ge.isPureReactComponent=!0;var Ve=Array.isArray,re={H:null,A:null,T:null,S:null,V:null},Qe=Object.prototype.hasOwnProperty;function Je(S,k,P,H,j,he){return P=he.ref,{$$typeof:s,type:S,key:k,ref:P!==void 0?P:null,props:he}}function $e(S,k){return Je(S.type,k,void 0,void 0,void 0,S.props)}function ft(S){return typeof S=="object"&&S!==null&&S.$$typeof===s}function te(S){var k={"=":"=0",":":"=2"};return"$"+S.replace(/[=:]/g,function(P){return k[P]})}var ce=/\/+/g;function $(S,k){return typeof S=="object"&&S!==null&&S.key!=null?te(""+S.key):k.toString(36)}function ye(){}function Ee(S){switch(S.status){case"fulfilled":return S.value;case"rejected":throw S.reason;default:switch(typeof S.status=="string"?S.then(ye,ye):(S.status="pending",S.then(function(k){S.status==="pending"&&(S.status="fulfilled",S.value=k)},function(k){S.status==="pending"&&(S.status="rejected",S.reason=k)})),S.status){case"fulfilled":return S.value;case"rejected":throw S.reason}}throw S}function Le(S,k,P,H,j){var he=typeof S;(he==="undefined"||he==="boolean")&&(S=null);var J=!1;if(S===null)J=!0;else switch(he){case"bigint":case"string":case"number":J=!0;break;case"object":switch(S.$$typeof){case s:case t:J=!0;break;case v:return J=S._init,Le(J(S._payload),k,P,H,j)}}if(J)return j=j(S),J=H===""?"."+$(S,0):H,Ve(j)?(P="",J!=null&&(P=J.replace(ce,"$&/")+"/"),Le(j,k,P,"",function(Hn){return Hn})):j!=null&&(ft(j)&&(j=$e(j,P+(j.key==null||S&&S.key===j.key?"":(""+j.key).replace(ce,"$&/")+"/")+J)),k.push(j)),1;J=0;var wt=H===""?".":H+":";if(Ve(S))for(var ke=0;ke<S.length;ke++)H=S[ke],he=wt+$(H,ke),J+=Le(H,k,P,he,j);else if(ke=C(S),typeof ke=="function")for(S=ke.call(S),ke=0;!(H=S.next()).done;)H=H.value,he=wt+$(H,ke++),J+=Le(H,k,P,he,j);else if(he==="object"){if(typeof S.then=="function")return Le(Ee(S),k,P,H,j);throw k=String(S),Error("Objects are not valid as a React child (found: "+(k==="[object Object]"?"object with keys {"+Object.keys(S).join(", ")+"}":k)+"). If you meant to render a collection of children, use an array instead.")}return J}function O(S,k,P){if(S==null)return S;var H=[],j=0;return Le(S,H,"","",function(he){return k.call(P,he,j++)}),H}function z(S){if(S._status===-1){var k=S._result;k=k(),k.then(function(P){(S._status===0||S._status===-1)&&(S._status=1,S._result=P)},function(P){(S._status===0||S._status===-1)&&(S._status=2,S._result=P)}),S._status===-1&&(S._status=0,S._result=k)}if(S._status===1)return S._result.default;throw S._result}var V=typeof reportError=="function"?reportError:function(S){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var k=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof S=="object"&&S!==null&&typeof S.message=="string"?String(S.message):String(S),error:S});if(!window.dispatchEvent(k))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",S);return}console.error(S)};function me(){}return ee.Children={map:O,forEach:function(S,k,P){O(S,function(){k.apply(this,arguments)},P)},count:function(S){var k=0;return O(S,function(){k++}),k},toArray:function(S){return O(S,function(k){return k})||[]},only:function(S){if(!ft(S))throw Error("React.Children.only expected to receive a single React element child.");return S}},ee.Component=Z,ee.Fragment=i,ee.Profiler=o,ee.PureComponent=Ne,ee.StrictMode=r,ee.Suspense=_,ee.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=re,ee.__COMPILER_RUNTIME={__proto__:null,c:function(S){return re.H.useMemoCache(S)}},ee.cache=function(S){return function(){return S.apply(null,arguments)}},ee.cloneElement=function(S,k,P){if(S==null)throw Error("The argument must be a React element, but you passed "+S+".");var H=U({},S.props),j=S.key,he=void 0;if(k!=null)for(J in k.ref!==void 0&&(he=void 0),k.key!==void 0&&(j=""+k.key),k)!Qe.call(k,J)||J==="key"||J==="__self"||J==="__source"||J==="ref"&&k.ref===void 0||(H[J]=k[J]);var J=arguments.length-2;if(J===1)H.children=P;else if(1<J){for(var wt=Array(J),ke=0;ke<J;ke++)wt[ke]=arguments[ke+2];H.children=wt}return Je(S.type,j,void 0,void 0,he,H)},ee.createContext=function(S){return S={$$typeof:h,_currentValue:S,_currentValue2:S,_threadCount:0,Provider:null,Consumer:null},S.Provider=S,S.Consumer={$$typeof:c,_context:S},S},ee.createElement=function(S,k,P){var H,j={},he=null;if(k!=null)for(H in k.key!==void 0&&(he=""+k.key),k)Qe.call(k,H)&&H!=="key"&&H!=="__self"&&H!=="__source"&&(j[H]=k[H]);var J=arguments.length-2;if(J===1)j.children=P;else if(1<J){for(var wt=Array(J),ke=0;ke<J;ke++)wt[ke]=arguments[ke+2];j.children=wt}if(S&&S.defaultProps)for(H in J=S.defaultProps,J)j[H]===void 0&&(j[H]=J[H]);return Je(S,he,void 0,void 0,null,j)},ee.createRef=function(){return{current:null}},ee.forwardRef=function(S){return{$$typeof:d,render:S}},ee.isValidElement=ft,ee.lazy=function(S){return{$$typeof:v,_payload:{_status:-1,_result:S},_init:z}},ee.memo=function(S,k){return{$$typeof:g,type:S,compare:k===void 0?null:k}},ee.startTransition=function(S){var k=re.T,P={};re.T=P;try{var H=S(),j=re.S;j!==null&&j(P,H),typeof H=="object"&&H!==null&&typeof H.then=="function"&&H.then(me,V)}catch(he){V(he)}finally{re.T=k}},ee.unstable_useCacheRefresh=function(){return re.H.useCacheRefresh()},ee.use=function(S){return re.H.use(S)},ee.useActionState=function(S,k,P){return re.H.useActionState(S,k,P)},ee.useCallback=function(S,k){return re.H.useCallback(S,k)},ee.useContext=function(S){return re.H.useContext(S)},ee.useDebugValue=function(){},ee.useDeferredValue=function(S,k){return re.H.useDeferredValue(S,k)},ee.useEffect=function(S,k,P){var H=re.H;if(typeof P=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return H.useEffect(S,k)},ee.useId=function(){return re.H.useId()},ee.useImperativeHandle=function(S,k,P){return re.H.useImperativeHandle(S,k,P)},ee.useInsertionEffect=function(S,k){return re.H.useInsertionEffect(S,k)},ee.useLayoutEffect=function(S,k){return re.H.useLayoutEffect(S,k)},ee.useMemo=function(S,k){return re.H.useMemo(S,k)},ee.useOptimistic=function(S,k){return re.H.useOptimistic(S,k)},ee.useReducer=function(S,k,P){return re.H.useReducer(S,k,P)},ee.useRef=function(S){return re.H.useRef(S)},ee.useState=function(S){return re.H.useState(S)},ee.useSyncExternalStore=function(S,k,P){return re.H.useSyncExternalStore(S,k,P)},ee.useTransition=function(){return re.H.useTransition()},ee.version="19.1.0",ee}var $g;function uh(){return $g||($g=1,Ef.exports=KS()),Ef.exports}var Ue=uh();const XS=gv(Ue);var Sf={exports:{}},ur={},Tf={exports:{}},bf={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var em;function WS(){return em||(em=1,function(s){function t(O,z){var V=O.length;O.push(z);e:for(;0<V;){var me=V-1>>>1,S=O[me];if(0<o(S,z))O[me]=z,O[V]=S,V=me;else break e}}function i(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var z=O[0],V=O.pop();if(V!==z){O[0]=V;e:for(var me=0,S=O.length,k=S>>>1;me<k;){var P=2*(me+1)-1,H=O[P],j=P+1,he=O[j];if(0>o(H,V))j<S&&0>o(he,H)?(O[me]=he,O[j]=V,me=j):(O[me]=H,O[P]=V,me=P);else if(j<S&&0>o(he,V))O[me]=he,O[j]=V,me=j;else break e}}return z}function o(O,z){var V=O.sortIndex-z.sortIndex;return V!==0?V:O.id-z.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;s.unstable_now=function(){return c.now()}}else{var h=Date,d=h.now();s.unstable_now=function(){return h.now()-d}}var _=[],g=[],v=1,E=null,C=3,x=!1,U=!1,G=!1,Z=!1,Q=typeof setTimeout=="function"?setTimeout:null,Ne=typeof clearTimeout=="function"?clearTimeout:null,ge=typeof setImmediate<"u"?setImmediate:null;function Ve(O){for(var z=i(g);z!==null;){if(z.callback===null)r(g);else if(z.startTime<=O)r(g),z.sortIndex=z.expirationTime,t(_,z);else break;z=i(g)}}function re(O){if(G=!1,Ve(O),!U)if(i(_)!==null)U=!0,Qe||(Qe=!0,$());else{var z=i(g);z!==null&&Le(re,z.startTime-O)}}var Qe=!1,Je=-1,$e=5,ft=-1;function te(){return Z?!0:!(s.unstable_now()-ft<$e)}function ce(){if(Z=!1,Qe){var O=s.unstable_now();ft=O;var z=!0;try{e:{U=!1,G&&(G=!1,Ne(Je),Je=-1),x=!0;var V=C;try{t:{for(Ve(O),E=i(_);E!==null&&!(E.expirationTime>O&&te());){var me=E.callback;if(typeof me=="function"){E.callback=null,C=E.priorityLevel;var S=me(E.expirationTime<=O);if(O=s.unstable_now(),typeof S=="function"){E.callback=S,Ve(O),z=!0;break t}E===i(_)&&r(_),Ve(O)}else r(_);E=i(_)}if(E!==null)z=!0;else{var k=i(g);k!==null&&Le(re,k.startTime-O),z=!1}}break e}finally{E=null,C=V,x=!1}z=void 0}}finally{z?$():Qe=!1}}}var $;if(typeof ge=="function")$=function(){ge(ce)};else if(typeof MessageChannel<"u"){var ye=new MessageChannel,Ee=ye.port2;ye.port1.onmessage=ce,$=function(){Ee.postMessage(null)}}else $=function(){Q(ce,0)};function Le(O,z){Je=Q(function(){O(s.unstable_now())},z)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(O){O.callback=null},s.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$e=0<O?Math.floor(1e3/O):5},s.unstable_getCurrentPriorityLevel=function(){return C},s.unstable_next=function(O){switch(C){case 1:case 2:case 3:var z=3;break;default:z=C}var V=C;C=z;try{return O()}finally{C=V}},s.unstable_requestPaint=function(){Z=!0},s.unstable_runWithPriority=function(O,z){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var V=C;C=O;try{return z()}finally{C=V}},s.unstable_scheduleCallback=function(O,z,V){var me=s.unstable_now();switch(typeof V=="object"&&V!==null?(V=V.delay,V=typeof V=="number"&&0<V?me+V:me):V=me,O){case 1:var S=-1;break;case 2:S=250;break;case 5:S=1073741823;break;case 4:S=1e4;break;default:S=5e3}return S=V+S,O={id:v++,callback:z,priorityLevel:O,startTime:V,expirationTime:S,sortIndex:-1},V>me?(O.sortIndex=V,t(g,O),i(_)===null&&O===i(g)&&(G?(Ne(Je),Je=-1):G=!0,Le(re,V-me))):(O.sortIndex=S,t(_,O),U||x||(U=!0,Qe||(Qe=!0,$()))),O},s.unstable_shouldYield=te,s.unstable_wrapCallback=function(O){var z=C;return function(){var V=C;C=z;try{return O.apply(this,arguments)}finally{C=V}}}}(bf)),bf}var tm;function ZS(){return tm||(tm=1,Tf.exports=WS()),Tf.exports}var Cf={exports:{}},pt={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tr(s){return JSON.parse(s)}function Ze(s){return JSON.stringify(s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uR=!0;function We(s,t=null){if(s===null)return X.EMPTY_NODE;if(typeof s=="object"&&".priority"in s&&(t=s[".priority"]),L(t===null||typeof t=="string"||typeof t=="number"||typeof t=="object"&&".sv"in t,"Invalid priority type found: "+typeof t),typeof s=="object"&&".value"in s&&s[".value"]!==null&&(s=s[".value"]),typeof s!="object"||".sv"in s){const i=s;return new st(i,We(t))}if(!(s instanceof Array)&&uR){const i=[];let r=!1;if(ct(s,(h,d)=>{if(h.substring(0,1)!=="."){const _=We(d);_.isEmpty()||(r=r||!_.getPriority().isEmpty(),i.push(new ae(h,_)))}}),i.length===0)return X.EMPTY_NODE;const c=Do(i,tR,h=>h.name,kh);if(r){const h=Do(i,qe.getCompare());return new X(c,We(t),new In({".priority":h},{".priority":qe}))}else return new X(c,We(t),In.Default)}else{let i=X.EMPTY_NODE;return ct(s,(r,o)=>{if(dn(s,r)&&r.substring(0,1)!=="."){const c=We(o);(c.isLeafNode()||!c.isEmpty())&&(i=i.updateImmediateChild(r,c))}}),i.updatePriority(We(t))}}iR(We);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cR extends Fo{constructor(t){super(),this.indexPath_=t,L(!ue(t)&&se(t)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(t){return t.getChild(this.indexPath_)}isDefinedOn(t){return!t.getChild(this.indexPath_).isEmpty()}compare(t,i){const r=this.extractChild(t.node),o=this.extractChild(i.node),c=r.compareTo(o);return c===0?ts(t.name,i.name):c}makePost(t,i){const r=We(t),o=X.EMPTY_NODE.updateChild(this.indexPath_,r);return new ae(i,o)}maxPost(){const t=X.EMPTY_NODE.updateChild(this.indexPath_,Vr);return new ae(Zi,t)}toString(){return Rr(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fR extends Fo{compare(t,i){const r=t.node.compareTo(i.node);return r===0?ts(t.name,i.name):r}isDefinedOn(t){return!0}indexedValueChanged(t,i){return!t.equals(i)}minPost(){return ae.MIN}maxPost(){return ae.MAX}makePost(t,i){const r=We(t);return new ae(i,r)}toString(){return".value"}}const hR=new fR;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uh{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=qe}hasStart(){return this.startSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return L(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return L(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:$s}hasEnd(){return this.endSet_}getIndexEndValue(){return L(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return L(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:Zi}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return L(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===qe}copy(){const t=new Uh;return t.limitSet_=this.limitSet_,t.limit_=this.limit_,t.startSet_=this.startSet_,t.startAfterSet_=this.startAfterSet_,t.indexStartValue_=this.indexStartValue_,t.startNameSet_=this.startNameSet_,t.indexStartName_=this.indexStartName_,t.endSet_=this.endSet_,t.endBeforeSet_=this.endBeforeSet_,t.indexEndValue_=this.indexEndValue_,t.endNameSet_=this.endNameSet_,t.indexEndName_=this.indexEndName_,t.index_=this.index_,t.viewFrom_=this.viewFrom_,t}}function _R(s){return s.loadsAllData()?new xh(s.getIndex()):s.hasLimit()?new pR(s):new Dr(s)}function Jm(s){const t={};if(s.isDefault())return t;let i;if(s.index_===qe?i="$priority":s.index_===hR?i="$value":s.index_===Ws?i="$key":(L(s.index_ instanceof cR,"Unrecognized index type!"),i=s.index_.toString()),t.orderBy=Ze(i),s.startSet_){const r=s.startAfterSet_?"startAfter":"startAt";t[r]=Ze(s.indexStartValue_),s.startNameSet_&&(t[r]+=","+Ze(s.indexStartName_))}if(s.endSet_){const r=s.endBeforeSet_?"endBefore":"endAt";t[r]=Ze(s.indexEndValue_),s.endNameSet_&&(t[r]+=","+Ze(s.indexEndName_))}return s.limitSet_&&(s.isViewFromLeft()?t.limitToFirst=s.limit_:t.limitToLast=s.limit_),t}function $m(s){const t={};if(s.startSet_&&(t.sp=s.indexStartValue_,s.startNameSet_&&(t.sn=s.indexStartName_),t.sin=!s.startAfterSet_),s.endSet_&&(t.ep=s.indexEndValue_,s.endNameSet_&&(t.en=s.indexEndName_),t.ein=!s.endBeforeSet_),s.limitSet_){t.l=s.limit_;let i=s.viewFrom_;i===""&&(s.isViewFromLeft()?i="l":i="r"),t.vf=i}return s.index_!==qe&&(t.i=s.index_.toString()),t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mo(){return{value:null,children:new Map}}function Gy(s,t,i){if(ue(t))s.value=i,s.children.clear();else if(s.value!==null)s.value=s.value.updateChild(t,i);else{const r=se(t);s.children.has(r)||s.children.set(r,Mo());const o=s.children.get(r);t=Me(t),Gy(o,t,i)}}function Jf(s,t,i){s.value!==null?i(t,s.value):mR(s,(r,o)=>{const c=new Re(t.toString()+"/"+r);Jf(o,c,i)})}function mR(s,t){s.children.forEach((i,r)=>{t(r,i)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ko{constructor(t,i,r){this.path=t,this.affectedTree=i,this.revert=r,this.type=tn.ACK_USER_WRITE,this.source=Lh()}operationForChild(t){if(ue(this.path)){if(this.affectedTree.value!=null)return L(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const i=this.affectedTree.subtree(new Re(t));return new ko(_e(),i,this.revert)}}else return L(se(this.path)===t,"operationForChild called for unrelated child."),new ko(Me(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ir{constructor(t,i){this.source=t,this.path=i,this.type=tn.LISTEN_COMPLETE}operationForChild(t){return ue(this.path)?new Ir(this.source,_e()):new Ir(this.source,Me(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ji{constructor(t,i,r){this.source=t,this.path=i,this.snap=r,this.type=tn.OVERWRITE}operationForChild(t){return ue(this.path)?new Ji(this.source,_e(),this.snap.getImmediateChild(t)):new Ji(this.source,Me(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ta{constructor(t,i,r){this.source=t,this.path=i,this.children=r,this.type=tn.MERGE}operationForChild(t){if(ue(this.path)){const i=this.children.subtree(new Re(t));return i.isEmpty()?null:i.value?new Ji(this.source,_e(),i.value):new ta(this.source,_e(),i)}else return L(se(this.path)===t,"Can't get a merge for a child not on the path of the operation"),new ta(this.source,Me(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Si{constructor(t,i,r){this.node_=t,this.fullyInitialized_=i,this.filtered_=r}isFullyInitialized(){return this.fullyInitialized_}isFiltered(){return this.filtered_}isCompleteForPath(t){if(ue(t))return this.isFullyInitialized()&&!this.filtered_;const i=se(t);return this.isCompleteForChild(i)}isCompleteForChild(t){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(t)}getNode(){return this.node_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Lf;const wR=()=>(Lf||(Lf=new At(cw)),Lf);class Ie{static fromObject(t){let i=new Ie(null);return ct(t,(r,o)=>{i=i.set(new Re(r),o)}),i}constructor(t,i=wR()){this.value=t,this.children=i}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(t,i){if(this.value!=null&&i(this.value))return{path:_e(),value:this.value};if(ue(t))return null;{const r=se(t),o=this.children.get(r);if(o!==null){const c=o.findRootMostMatchingPathAndValue(Me(t),i);return c!=null?{path:Be(new Re(r),c.path),value:c.value}:null}else return null}}findRootMostValueAndPath(t){return this.findRootMostMatchingPathAndValue(t,()=>!0)}subtree(t){if(ue(t))return this;{const i=se(t),r=this.children.get(i);return r!==null?r.subtree(Me(t)):new Ie(null)}}set(t,i){if(ue(t))return new Ie(i,this.children);{const r=se(t),c=(this.children.get(r)||new Ie(null)).set(Me(t),i),h=this.children.insert(r,c);return new Ie(this.value,h)}}remove(t){if(ue(t))return this.children.isEmpty()?new Ie(null):new Ie(null,this.children);{const i=se(t),r=this.children.get(i);if(r){const o=r.remove(Me(t));let c;return o.isEmpty()?c=this.children.remove(i):c=this.children.insert(i,o),this.value===null&&c.isEmpty()?new Ie(null):new Ie(this.value,c)}else return this}}get(t){if(ue(t))return this.value;{const i=se(t),r=this.children.get(i);return r?r.get(Me(t)):null}}setTree(t,i){if(ue(t))return i;{const r=se(t),c=(this.children.get(r)||new Ie(null)).setTree(Me(t),i);let h;return c.isEmpty()?h=this.children.remove(r):h=this.children.insert(r,c),new Ie(this.value,h)}}fold(t){return this.fold_(_e(),t)}fold_(t,i){const r={};return this.children.inorderTraversal((o,c)=>{r[o]=c.fold_(Be(t,o),i)}),i(t,this.value,r)}findOnPath(t,i){return this.findOnPath_(t,_e(),i)}findOnPath_(t,i,r){const o=this.value?r(i,this.value):!1;if(o)return o;if(ue(t))return null;{const c=se(t),h=this.children.get(c);return h?h.findOnPath_(Me(t),Be(i,c),r):null}}foreachOnPath(t,i){return this.foreachOnPath_(t,_e(),i)}foreachOnPath_(t,i,r){if(ue(t))return this;{this.value&&r(i,this.value);const o=se(t),c=this.children.get(o);return c?c.foreachOnPath_(Me(t),Be(i,o),r):new Ie(null)}}foreach(t){this.foreach_(_e(),t)}foreach_(t,i){this.children.inorderTraversal((r,o)=>{o.foreach_(Be(t,r),i)}),this.value&&i(t,this.value)}foreachChild(t){this.children.inorderTraversal((i,r)=>{r.value&&t(i,r.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nn{constructor(t){this.writeTree_=t}static empty(){return new nn(new Ie(null))}}function Er(s,t,i){if(ue(t))return new nn(new Ie(i));{const r=s.writeTree_.findRootMostValueAndPath(t);if(r!=null){const o=r.path;let c=r.value;const h=gt(o,t);return c=c.updateChild(h,i),new nn(s.writeTree_.set(o,c))}else{const o=new Ie(i),c=s.writeTree_.setTree(t,o);return new nn(c)}}}function $f(s,t,i){let r=s;return ct(i,(o,c)=>{r=Er(r,Be(t,o),c)}),r}function tv(s,t){if(ue(t))return nn.empty();{const i=s.writeTree_.setTree(t,new Ie(null));return new nn(i)}}function eh(s,t){return ns(s,t)!=null}function ns(s,t){const i=s.writeTree_.findRootMostValueAndPath(t);return i!=null?s.writeTree_.get(i.path).getChild(gt(i.path,t)):null}function nv(s){const t=[],i=s.writeTree_.value;return i!=null?i.isLeafNode()||i.forEachChild(qe,(r,o)=>{t.push(new ae(r,o))}):s.writeTree_.children.inorderTraversal((r,o)=>{o.value!=null&&t.push(new ae(r,o.value))}),t}function vi(s,t){if(ue(t))return s;{const i=ns(s,t);return i!=null?new nn(new Ie(i)):new nn(s.writeTree_.subtree(t))}}function th(s){return s.writeTree_.isEmpty()}function na(s,t){return Yy(_e(),s.writeTree_,t)}function Yy(s,t,i){if(t.value!=null)return i.updateChild(s,t.value);{let r=null;return t.children.inorderTraversal((o,c)=>{o===".priority"?(L(c.value!==null,"Priority writes must always be leaf nodes"),r=c.value):i=Yy(Be(s,o),c,i)}),!i.getChild(s).isEmpty()&&r!==null&&(i=i.updateChild(Be(s,".priority"),r)),i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ko(s,t){return Xy(t,s)}function RR(s,t,i,r,o){L(r>s.lastWriteId,"Stacking an older write on top of newer ones"),o===void 0&&(o=!0),s.allWrites.push({path:t,snap:i,writeId:r,visible:o}),o&&(s.visibleWrites=Er(s.visibleWrites,t,i)),s.lastWriteId=r}function NR(s,t,i,r){L(r>s.lastWriteId,"Stacking an older merge on top of newer ones"),s.allWrites.push({path:t,children:i,writeId:r,visible:!0}),s.visibleWrites=$f(s.visibleWrites,t,i),s.lastWriteId=r}function OR(s,t){for(let i=0;i<s.allWrites.length;i++){const r=s.allWrites[i];if(r.writeId===t)return r}return null}function DR(s,t){const i=s.allWrites.findIndex(d=>d.writeId===t);L(i>=0,"removeWrite called with nonexistent writeId.");const r=s.allWrites[i];s.allWrites.splice(i,1);let o=r.visible,c=!1,h=s.allWrites.length-1;for(;o&&h>=0;){const d=s.allWrites[h];d.visible&&(h>=i&&IR(d,r.path)?o=!1:Ft(r.path,d.path)&&(c=!0)),h--}if(o){if(c)return MR(s),!0;if(r.snap)s.visibleWrites=tv(s.visibleWrites,r.path);else{const d=r.children;ct(d,_=>{s.visibleWrites=tv(s.visibleWrites,Be(r.path,_))})}return!0}else return!1}function IR(s,t){if(s.snap)return Ft(s.path,t);for(const i in s.children)if(s.children.hasOwnProperty(i)&&Ft(Be(s.path,i),t))return!0;return!1}function MR(s){s.visibleWrites=Fy(s.allWrites,kR,_e()),s.allWrites.length>0?s.lastWriteId=s.allWrites[s.allWrites.length-1].writeId:s.lastWriteId=-1}function kR(s){return s.visible}function Fy(s,t,i){let r=nn.empty();for(let o=0;o<s.length;++o){const c=s[o];if(t(c)){const h=c.path;let d;if(c.snap)Ft(i,h)?(d=gt(i,h),r=Er(r,d,c.snap)):Ft(h,i)&&(d=gt(h,i),r=Er(r,_e(),c.snap.getChild(d)));else if(c.children){if(Ft(i,h))d=gt(i,h),r=$f(r,d,c.children);else if(Ft(h,i))if(d=gt(h,i),ue(d))r=$f(r,_e(),c.children);else{const _=Zs(c.children,se(d));if(_){const g=_.getChild(Me(d));r=Er(r,_e(),g)}}}else throw sa("WriteRecord should have .snap or .children")}}return r}function Qy(s,t,i,r,o){if(!r&&!o){const c=ns(s.visibleWrites,t);if(c!=null)return c;{const h=vi(s.visibleWrites,t);if(th(h))return i;if(i==null&&!eh(h,_e()))return null;{const d=i||X.EMPTY_NODE;return na(h,d)}}}else{const c=vi(s.visibleWrites,t);if(!o&&th(c))return i;if(!o&&i==null&&!eh(c,_e()))return null;{const h=function(g){return(g.visible||o)&&(!r||!~r.indexOf(g.writeId))&&(Ft(g.path,t)||Ft(t,g.path))},d=Fy(s.allWrites,h,t),_=i||X.EMPTY_NODE;return na(d,_)}}}function xR(s,t,i){let r=X.EMPTY_NODE;const o=ns(s.visibleWrites,t);if(o)return o.isLeafNode()||o.forEachChild(qe,(c,h)=>{r=r.updateImmediateChild(c,h)}),r;if(i){const c=vi(s.visibleWrites,t);return i.forEachChild(qe,(h,d)=>{const _=na(vi(c,new Re(h)),d);r=r.updateImmediateChild(h,_)}),nv(c).forEach(h=>{r=r.updateImmediateChild(h.name,h.node)}),r}else{const c=vi(s.visibleWrites,t);return nv(c).forEach(h=>{r=r.updateImmediateChild(h.name,h.node)}),r}}function UR(s,t,i,r,o){L(r||o,"Either existingEventSnap or existingServerSnap must exist");const c=Be(t,i);if(eh(s.visibleWrites,c))return null;{const h=vi(s.visibleWrites,c);return th(h)?o.getChild(i):na(h,o.getChild(i))}}function LR(s,t,i,r){const o=Be(t,i),c=ns(s.visibleWrites,o);if(c!=null)return c;if(r.isCompleteForChild(i)){const h=vi(s.visibleWrites,o);return na(h,r.getNode().getImmediateChild(i))}else return null}function zR(s,t){return ns(s.visibleWrites,t)}function HR(s,t,i,r,o,c,h){let d;const _=vi(s.visibleWrites,t),g=ns(_,_e());if(g!=null)d=g;else if(i!=null)d=na(_,i);else return[];if(d=d.withIndex(h),!d.isEmpty()&&!d.isLeafNode()){const v=[],E=h.getCompare(),C=c?d.getReverseIteratorFrom(r,h):d.getIteratorFrom(r,h);let x=C.getNext();for(;x&&v.length<o;)E(x,r)!==0&&v.push(x),x=C.getNext();return v}else return[]}function PR(){return{visibleWrites:nn.empty(),allWrites:[],lastWriteId:-1}}function Uo(s,t,i,r){return Qy(s.writeTree,s.treePath,t,i,r)}function Ph(s,t){return xR(s.writeTree,s.treePath,t)}function iv(s,t,i,r){return UR(s.writeTree,s.treePath,t,i,r)}function Lo(s,t){return zR(s.writeTree,Be(s.treePath,t))}function BR(s,t,i,r,o,c){return HR(s.writeTree,s.treePath,t,i,r,o,c)}function Bh(s,t,i){return LR(s.writeTree,s.treePath,t,i)}function Ky(s,t){return Xy(Be(s.treePath,t),s.writeTree)}function Xy(s,t){return{treePath:s,writeTree:t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ZR{constructor(t,i){this.query_=t,this.eventRegistrations_=[];const r=this.query_._queryParams,o=new xh(r.getIndex()),c=_R(r);this.processor_=GR(c);const h=i.serverCache,d=i.eventCache,_=o.updateFullNode(X.EMPTY_NODE,h.getNode(),null),g=c.updateFullNode(X.EMPTY_NODE,d.getNode(),null),v=new Si(_,h.isFullyInitialized(),o.filtersNodes()),E=new Si(g,d.isFullyInitialized(),c.filtersNodes());this.viewCache_=Qo(E,v),this.eventGenerator_=new TR(this.query_)}get query(){return this.query_}}function JR(s){return s.viewCache_.serverCache.getNode()}function $R(s){return xo(s.viewCache_)}function e1(s,t){const i=$i(s.viewCache_);return i&&(s.query._queryParams.loadsAllData()||!ue(t)&&!i.getImmediateChild(se(t)).isEmpty())?i.getChild(t):null}function rv(s){return s.eventRegistrations_.length===0}function t1(s,t){s.eventRegistrations_.push(t)}function lv(s,t,i){const r=[];if(i){L(t==null,"A cancel should cancel all event registrations.");const o=s.query._path;s.eventRegistrations_.forEach(c=>{const h=c.createCancelEvent(i,o);h&&r.push(h)})}if(t){let o=[];for(let c=0;c<s.eventRegistrations_.length;++c){const h=s.eventRegistrations_[c];if(!h.matches(t))o.push(h);else if(t.hasAnyCallback()){o=o.concat(s.eventRegistrations_.slice(c+1));break}}s.eventRegistrations_=o}else s.eventRegistrations_=[];return r}function ov(s,t,i,r){t.type===tn.MERGE&&t.source.queryId!==null&&(L($i(s.viewCache_),"We should always have a full cache before handling merges"),L(xo(s.viewCache_),"Missing event cache, even though we have a server cache"));const o=s.viewCache_,c=YR(s.processor_,o,t,i,r);return jR(s.processor_,c.viewCache),L(c.viewCache.serverCache.isFullyInitialized()||!o.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),s.viewCache_=c.viewCache,Jy(s,c.changes,c.viewCache.eventCache.getNode(),null)}function n1(s,t){const i=s.viewCache_.eventCache,r=[];return i.getNode().isLeafNode()||i.getNode().forEachChild(qe,(c,h)=>{r.push(ea(c,h))}),i.isFullyInitialized()&&r.push(Vy(i.getNode())),Jy(s,r,i.getNode(),t)}function Jy(s,t,i,r){const o=r?[r]:s.eventRegistrations_;return bR(s.eventGenerator_,t,i,o)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wh{constructor(t="",i=null,r={children:{},childCount:0}){this.name=t,this.parent=i,this.node=r}}function Zh(s,t){let i=t instanceof Re?t:new Re(t),r=s,o=se(i);for(;o!==null;){const c=Zs(r.node.children,o)||{children:{},childCount:0};r=new Wh(o,r,c),i=Me(i),o=se(i)}return r}function ca(s){return s.node.value}function fE(s,t){s.node.value=t,ah(s)}function hE(s){return s.node.childCount>0}function C1(s){return ca(s)===void 0&&!hE(s)}function Zo(s,t){ct(s.node.children,(i,r)=>{t(new Wh(i,s,r))})}function dE(s,t,i,r){i&&t(s),Zo(s,o=>{dE(o,t,!0)})}function A1(s,t,i){let r=s.parent;for(;r!==null;){if(t(r))return!0;r=r.parent}return!1}function jr(s){return new Re(s.parent===null?s.name:jr(s.parent)+"/"+s.name)}function ah(s){s.parent!==null&&w1(s.parent,s.name,s)}function w1(s,t,i){const r=C1(i),o=dn(s.node.children,t);r&&o?(delete s.node.children[t],s.node.childCount--,ah(s)):!r&&!o&&(s.node.children[t]=i.node,s.node.childCount++,ah(s))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nN{constructor(t,i,r,o){this.eventType=t,this.eventRegistration=i,this.snapshot=r,this.prevName=o}getPath(){const t=this.snapshot.ref;return this.eventType==="value"?t._path:t.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+Ze(this.snapshot.exportVal())}}class iN{constructor(t,i,r){this.eventRegistration=t,this.error=i,this.path=r}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */mi(gN,mN,"app");const vN={apiKey:"AIzaSyDWMkL3P7OWlosSFXXRg8gvUQg6-7Y9uu8",authDomain:"esp32door-control.firebaseapp.com",databaseURL:"https://esp32door-control-default-rtdb.firebaseio.com/",projectId:"esp32door-control",storageBucket:"esp32door-control.appspot.com",messagingSenderId:"605127991992",appId:"1:605127991992:web:4d0dccf6ae2d874603ca4d",measurementId:"G-91SJ3GLZ0Z"},bE=Nv(vN),fo=ew(bE),Jt=dN(bE),yN=15,EN=()=>Array.from({length:8},()=>"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".charAt(Math.floor(Math.random()*62))).join("");function SN(){const[s,t]=Ue.useState(null),[i,r]=Ue.useState([]),[o,c]=Ue.useState({}),[h,d]=Ue.useState({}),[_,g]=Ue.useState(!1),[v,E]=Ue.useState(!1),[C,x]=Ue.useState(null),U=Ue.useRef(null),G=Ue.useCallback(()=>{U.current&&(clearTimeout(U.current),U.current=null),x(null)},[]),Z=Ue.useCallback(te=>{U.current&&clearTimeout(U.current),x(te),te&&(U.current=setTimeout(()=>{x(null),U.current=null},4e3))},[]),Q=async(te,ce)=>{G();try{(await HC(fo,te,ce)).user&&console.log("User registered and initial tokens set.")}catch($){$.code==="auth/email-already-in-use"?Z("Email already registered"):$.code==="auth/weak-password"?Z("6 characters or more"):$.code==="auth/invalid-email"?Z("Invalid email"):Z("Registration failed. Please try again.")}},Ne=async(te,ce)=>{G();try{await PC(fo,te,ce)}catch($){["auth/user-not-found","auth/invalid-credential","auth/wrong-password","auth/invalid-email"].includes($.code),Z("Wrong email or password")}},ge=async()=>{G(),await GC(fo)},Ve=async te=>{const ce=`tokens/${te}/buttonStatus`,$=await co(Zt(Jt,ce)),Ee=($.exists()?$.val():"closed")==="open"?"closed":"open";await Gs(Zt(Jt,ce),Ee)},re=async(te,ce)=>{if(!s||!i.includes(te))return;const $=`tokens/${te}/buttonName`;try{await Gs(Zt(Jt,$),ce||null)}catch(ye){console.error("Error updating button name:",ye),Z("Failed to update name.")}},Qe=async(te,ce)=>{await Gs(Zt(Jt,`tokens/${te}/authorizedUsers/${ce}`),!0);const $=Zt(Jt,`users/${ce}/deviceTokens`),ye=await co($),Ee=ye.exists()&&Array.isArray(ye.val())?ye.val():[];Ee.includes(te)||await Gs($,[...Ee,te])},Je=async(te,ce)=>{await Gs(Zt(Jt,`tokens/${te}/authorizedUsers/${ce}`),null);const $=Zt(Jt,`users/${ce}/deviceTokens`),ye=await co($),Ee=ye.exists()&&Array.isArray(ye.val())?ye.val():[];Ee.includes(te)&&await Gs($,Ee.filter(Le=>Le!==te))},$e=Ue.useCallback(async te=>{const ce=Zt(Jt,`users/${te}/deviceTokens`),$=await co(ce);let ye=[];if($.exists()&&Array.isArray($.val()))ye=$.val();else{const Ee=Array.from({length:yN},EN);ye=Ee;const Le={[`/users/${te}/deviceTokens`]:ye};Ee.forEach(O=>{Le[`/tokens/${O}`]={owner:te,authorizedUsers:{[te]:!0},buttonStatus:"hello"}}),await sN(Zt(Jt),Le)}r(ye),g(!1),ft(ye)},[]),ft=te=>{const ce={},$={};if(c({}),d({}),g(!1),te.length===0){g(!0);return}const ye=()=>{Object.keys(ce).length===te.length&&Object.keys($).length===te.length&&g(!0)};te.forEach(Ee=>{const Le=Zt(Jt,`tokens/${Ee}/buttonStatus`);_v(Le,z=>{let V=z.val();typeof V!="string"&&(V="closed"),c(me=>({...me,[Ee]:V})),ce[Ee]=!0,ye()},z=>{console.error(`Error listening to status for ${Ee}:`,z),ce[Ee]=!0,ye()});const O=Zt(Jt,`tokens/${Ee}/buttonName`);_v(O,z=>{const V=z.val()||null;d(me=>({...me,[Ee]:V})),$[Ee]=!0,ye()},z=>{console.error(`Error listening to name for ${Ee}:`,z),$[Ee]=!0,ye()})})};return Ue.useEffect(()=>VC(fo,ce=>{t(ce),ce?$e(ce.uid):(r([]),c({}),d({}),g(!1),G()),E(!0)}),[$e,G]),Ue.useEffect(()=>()=>{U.current&&clearTimeout(U.current)},[]),{user:s,tokens:i,buttonState:o,buttonNames:h,isButtonDataLoaded:_,authChecked:v,error:C,register:Q,login:Ne,logout:ge,toggleButton:Ve,updateButtonName:re,shareToken:Qe,revokeShare:Je,clearError:G}}function TN(){const{user:s,token:t,tokens:i,buttonState:r,isButtonDataLoaded:o,buttonNames:c,updateButtonName:h,error:d,register:_,login:g,logout:v,toggleButton:E,clearError:C}=SN(),[x,U]=Ue.useState(!1);return Ue.useEffect(()=>{if(d){U(!0);const G=setTimeout(()=>U(!1),3500);return()=>clearTimeout(G)}else U(!1)},[d]),pe.jsxs("div",{id:"appContainer",className:"fade-in background",children:[d&&pe.jsx("div",{className:`error-banner ${x?"visible":"fade-out"}`,children:d}),pe.jsxs("div",{className:s?"control-panel-screen":"container",id:"containerEl",children:[pe.jsx("h1",{className:"title",children:s?"":"Welcome to the future"}),s?pe.jsx(aT,{token:t,tokens:i,buttonState:r,buttonNames:c,isButtonDataLoaded:o,onToggle:E,onUpdateName:h,onLogout:v}):pe.jsx(sT,{onLogin:g,onRegister:_,error:d,setError:C})]})]})}iT.createRoot(document.getElementById("root")).render(pe.jsx(XS.StrictMode,{children:pe.jsx(TN,{})}));"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/STARR/service-worker.js").then(s=>{console.log("✅ Service Worker registered with scope:",s.scope),s.onupdatefound=()=>{const t=s.installing;t&&(t.onstatechange=()=>{t.state==="installed"&&navigator.serviceWorker.controller&&confirm("🚀 New version available! Reload now?")&&window.location.reload()})}}).catch(s=>{console.error("❌ Service Worker registration failed:",s)})});
